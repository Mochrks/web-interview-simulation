...
import { MessageSquare, Code2, Terminal, Briefcase, CheckCircle2 } from 'lucide-react';
...
const stages: { id: InterviewStage; label: string; icon: React.ReactNode }[] = [
    { id: 'behavioral', label: 'Behavioral', icon: <MessageSquare className="w-5 h-5" /> },
    { id: 'technical', label: 'Technical', icon: <Code2 className="w-5 h-5" /> },
    { id: 'coding', label: 'Live Coding', icon: <Terminal className="w-5 h-5" /> },
    { id: 'final', label: 'Final Round', icon: <Briefcase className="w-5 h-5" /> }
];
        ...
        <div className="bauhaus-card bg-card">
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                `}
                  ...
                  `}>
                                        {isCompleted ? <CheckCircle2 className="w-6 h-6 text-white" /> : stage.icon}
                                    </div>
