...
import { evaluateAnswer, analyzeVoiceResponse, evaluateCode } from '@/lib/interviewUtils';
...
export default function InterviewSimulator({ onComplete }: InterviewSimulatorProps) {
    const [currentStage, setCurrentStage] = useState<InterviewStage>('behavioral');
    ...
    const handleSubmitAnswer = () => {
        ...
        if (currentStage === 'coding') {
            ...
            codeEval = evaluateCode(currentCode, testsPassed, challenge.testCases.length);
            evaluation = codeEval;
            ...
            evaluation = {
                ...
                feedback: isCorrect ? 'Correct!' : `Incorrect. The correct answer is: ${correctOption?.text}`
            };
        } else {
    ...
    const handleCompleteStage = () => {
        ...
        const stageOrder: InterviewStage[] = ['behavioral', 'technical', 'coding', 'final'];
            ...
            try {
                ...
                try {
                    if (selectedLanguage === 'javascript' || selectedLanguage === 'typescript') {
                        ...
                        output += challenge.testCases.map((tc, i) =>
            ...
            return (
                <div className="space-y-6">
                    <div className="bauhaus-card">
                        <h2 className="bauhaus-subheading text-2xl mb-4">{challenge.title}</h2>
                        <div className="flex items-center gap-4 mb-4">
                            <span className={`px-4 py-1 border-3 border-foreground font-bold uppercase text-sm
                ${challenge.difficulty === 'easy' ? 'bauhaus-accent-blue' :
                                    challenge.difficulty === 'medium' ? 'bauhaus-accent-yellow' : 'bauhaus-accent-red'}`}>
    ...
    return (
        <div className="min-h-screen bg-background p-6 space-y-8">
            <div className="bauhaus-card bauhaus-accent-red">
                <h1 className="bauhaus-heading text-4xl md:text-5xl">Interview Simulation</h1>
                <p className="text-lg mt-2 opacity-90">Professional Job Interview Practice</p>
            </div>
                ...
                <div className="flex justify-between items-center">
                    ...
                    <div className="text-center">
                        <p className="text-sm text-muted-foreground">
                            Stage Progress: {currentQuestionIndex + 1} / {questions.length}
                        </p>
                    </div>

                    <Button
                        onClick={handleSubmitAnswer}
                        disabled={!currentAnswer && !voiceTranscript && currentStage !== 'coding'}
