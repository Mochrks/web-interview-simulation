        ...
        <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        {voiceSupport.tts && (
                            <Button
                                ...
                                className={`bauhaus-btn ${isSpeaking ? 'bauhaus-accent-yellow' : 'bauhaus-accent-blue'}`}
                            >
                                {isSpeaking ? (
                                    <>
                        ...
                        {voiceSupport.stt && (
                            <Button
                                ...
                                className={`bauhaus-btn ${isListening ? 'bauhaus-accent-red animate-pulse' : 'bauhaus-accent-blue'}`}
                            >
                                {isListening ? (
                                    <>
                ...
                {(!voiceSupport.tts || !voiceSupport.stt) && (
                    <div className="mt-4 p-3 border-3 border-yellow-600 bg-yellow-50 text-yellow-900">
                        ...
                        <p className="text-sm mt-1">
                            ...
                            Please use a modern browser like Chrome or Edge for full voice features.
                        </p>
                    </div>
                )}
            </div>
            ...
            {transcript && (
                <div className="bauhaus-card animate-slide-up">
                    <h4 className="font-bold uppercase mb-2 text-lg">Your Answer (Transcribed):</h4>
            ...
            {isListening && recordingStartTime && (
                <div className="bauhaus-card bauhaus-accent-red animate-pulse">
                    <div className="flex items-center justify-between">
                        <span className="font-bold uppercase">🔴 Recording in Progress</span>
